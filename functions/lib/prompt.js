...
exports.ROCK_ID_SYSTEM_PROMPT = void 0;
exports.buildRockIdUserPrompt = buildRockIdUserPrompt;
exports.ROCK_ID_SYSTEM_PROMPT = `
...
function buildRockIdUserPrompt(params = {}) {
    ...
    if (location_hint)
        prompt.push(`location_hint: ${location_hint}`);
    if (context_notes)
        prompt.push(`context_notes: ${context_notes}`);
